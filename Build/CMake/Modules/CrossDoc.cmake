...
if (CLDOC)
    ...
    get_directory_property(DEFS DIRECTORY ${CROSS_SOURCE_DIR} COMPILE_DEFINITIONS)
    ...
    SET(doc_args generate ${CXX_LIST} ${C_LIST} -std=c++11 -DCROSS_DEV_BUILD=1 ${DOC_DEFINES} ${DOC_INCLUDES} -- --type html --language c++ --output ${CROSS_SOURCE_DIR}/Artifacts/Build/CrossDocs)
