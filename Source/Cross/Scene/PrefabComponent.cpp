...
PrefabComponent::PrefabComponent(Context* context) :
    Component(context)
{
    SubscribeToEvent(E_PREFABCHANGED, CROSS_HANDLER(PrefabComponent, HandlePrefabChanged));
}
...
void PrefabComponent::RegisterObject(Context* context)
{
    ...
    CROSS_ACCESSOR_ATTRIBUTE("PrefabGUID", GetPrefabGUID, SetPrefabGUID, String, String::EMPTY, AM_FILE | AM_NOEDIT);
}
