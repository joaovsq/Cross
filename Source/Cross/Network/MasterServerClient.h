//
// Communication with an cross master server
...
/// Client for master server, see Script/CrossMasterServer for example master server implementation
class CROSS_API MasterServerClient : public Object
{
    CROSS_OBJECT(MasterServerClient, Object);
