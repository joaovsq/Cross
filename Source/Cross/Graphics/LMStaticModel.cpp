...
// https://github.com/CrossGameEngine/CrossGameEngine
...
void LMStaticModel::RegisterObject(Context* context)
{
    ...
    CROSS_COPY_BASE_ATTRIBUTES(StaticModel);
    CROSS_ATTRIBUTE("Lightmap Tiling Offset", Vector4, lightmapTilingOffset_ , Vector4(1.0f, 1.0f, 0.0f, 0.0f), AM_DEFAULT);
    CROSS_MIXED_ACCESSOR_ATTRIBUTE("LightmapTexture", GetLightmapTextureAttr, SetLightmapTextureAttr, ResourceRef, ResourceRef(Texture2D::GetTypeStatic()), AM_DEFAULT);
